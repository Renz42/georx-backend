...
<head>
    ...
    <title>User Registration - GEORX</title>
...
<body class="bg-geo-50 min-h-screen flex items-center justify-center p-4 relative overflow-hidden font-sans text-geo-900 py-10">
    ...
    <div class="max-w-md w-full relative z-10 animate-fade-in-up">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-4xl font-extrabold tracking-tight mb-2 text-geo-900">Join GEORX</h1>
            <p class="text-geo-600 font-medium text-base">Create an account to track your medicine reservations.</p>
        </div>
        ...
        <div class="glass-panel rounded-3xl shadow-2xl p-8 sm:p-10 relative overflow-hidden">
            ...
            @if($errors->any())
                <div class="bg-red-50/80 backdrop-blur-sm border border-red-200 text-red-600 px-5 py-4 rounded-2xl mb-6 text-sm font-semibold animate-fade-in-up shadow-sm">
                    ...
                    <ul class="list-disc list-inside space-y-1 ml-6 font-medium">
            ...
            <form method="POST" action="{{ route('register') }}" class="relative z-10">
                ...
                <div class="mb-5">
                    <label class="block text-sm font-bold text-geo-800 mb-2">Full Name</label>
                    <div class="relative group">
                        <i class="fas fa-user absolute left-4 top-1/2 -translate-y-1/2 text-geo-400 group-focus-within:text-geo-600 transition-colors duration-300"></i>
                ...
                <div class="mb-5">
                    <label class="block text-sm font-bold text-geo-800 mb-2">Password</label>
                    <div class="relative group">
                ...
                <div class="mb-8">
                    <label class="block text-sm font-bold text-geo-800 mb-2">Confirm Password</label>
                    <div class="relative group">
                        <i class="fas fa-lock absolute left-4 top-1/2 -translate-y-1/2 text-geo-400 group-focus-within:text-geo-600 transition-colors duration-300"></i>
            ...
            <div class="mt-8 pt-6 border-t border-geo-900/10 text-center relative z-10">
                <p class="text-geo-900/60 text-sm mb-3 font-medium">Already have an account?</p>
                <a href="{{ route('login') }}" class="inline-flex items-center justify-center w-full bg-white/60 hover:bg-white text-geo-700 font-bold py-3.5 rounded-2xl transition-all border border-white shadow-sm hover:shadow-md">
                    Sign in instead
                </a>
            </div>
        </div>
